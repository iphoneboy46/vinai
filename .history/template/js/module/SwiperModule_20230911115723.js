export default function SwiperModule() {
  try {
    ...
    if (aboutOur) {
      var swiperBt = new Swiper(aboutOur.querySelector('.mySwiperBT'), {
        ...
        loop: true,
        navigation: {
          nextEl: aboutOur.querySelector('.next'),
          prevEl: aboutOur.querySelector('.prev'),
        },
        speed: 800,
      });
  ...
  if(aboutMile){
    ...
    var swiperYear = new Swiper(aboutMile.querySelector(".mySwiperYear"), {
      ...
      allowTouchMove: false,
      navigation: {
        nextEl: aboutMile.querySelector(".next"),
        prevEl: aboutMile.querySelector(".prev"),
      },
      autoplay: {
        delay: 5000,
      },
    ...
    swiperYear.controller.control = swiperTitle;
    swiperYear.controller.control = swiperNumber;
    swiperNumber.controller.control = swiperTitle;
