        ...
        class Wave {
          ...
          draw() {
            ...
            for (let i = 0; i < canvas.width; i++) {
              ctx.lineTo(
                i,canvas.height / 2 + Math.sin(i * this.length + this.increment) * this.sin * Math.sin(this.increment * 3)
              );
        ...
        function handleWave() {
          for (let i = 0; i < lineWaveArray.length; i++) {
            ...
            if(lineWaveArray[i].frequency < 1){
                lineWaveArray[i].frequency += Math.random() * 0.0001
            }
    
            if(lineWaveArray[i].increment >= 2){
                lineWaveArray[i].increment -= 1;
                lineWaveArray[i].frequency -=  Math.random() * 0.009;
